export default function MapCanvas({ layers }) {
  return <div className="map" role="img" aria-label="Mock cadastral map">
    <div className="north">N ↑</div><div className="scale">50 m</div>
    <svg viewBox="0 0 720 430" preserveAspectRatio="none">
      {layers.imagery && <rect width="720" height="430" fill="#d5e3d1" />}
    ...
    </svg><span className="map-label">Central Ward · published data</span>
  </div>;
}
